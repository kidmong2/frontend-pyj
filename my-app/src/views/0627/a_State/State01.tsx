...
export default function State01() {
  ...
  const handleUpClick = () => {
    ...
    // setCount(count + 1); // 동일한 렌더링 사이클에서 렌더링 실행
  ...
  return (
    <div>
      ...
      <button onClick={handleUpClick}>카운트를 증가</button>
      <button onClick={handleDownClick}>카운트를 감소</button>
    </div>
  );
}
