...
const ItemComponent = ({item, onRemove, onEdit}: ItemProps) => {
  ...
  return (
    <div>
      ...
      <input type="number" value={item.amount} onChange={(e) => onEdit(item.id, parseInt(e.target.value))} />
...
export default function Array05() {
  ...
  return (
    <div>
      ...
      <ItemList items={items} onEdit={handleAmountEdit} onRemove={handleItemRemove} />
