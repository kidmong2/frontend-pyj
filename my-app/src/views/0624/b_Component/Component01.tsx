...
// src 폴더 내에서 이미지 사용
// : import 문으로 이미지를 모듈처럼 불러와 사용
// : webpack이 이미지를 번들링하고 경로처리가 가능
...
export function Img() {
  ...
  return <img src={dog01} alt="강아지" width={400} />;
}
...
export default function Component01() {
  ...
  return (
    <div>
      <p>고양이 이미지 - img 태그 사용</p>
      <img
        src="https://cdn.pixabay.com/photo/2014/11/30/14/11/cat-551554_640.jpg"
        alt="img 태그 고양이"
        width={200}
      />
      <img src="images/cat01.jpg" alt="img 태그 고양이" width={200} />
      <img src={cat01} alt="img 태그 고양이" width={200} />
