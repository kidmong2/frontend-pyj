...
document.cookie = "username=yongjae; path=/;"
...
let date = new Date(); // 실시간 날짜, 시간 생성
date.setTime(date.getTime() + (60 * 60 * 1000)); // 1000 * 60 * 60 = 1시간 (ms)
// KST = UTC(+9)

let expires = 'expires=' + date.toUTCString();
document.cookie = "username=yongjae; path=/;" + expires + ';'
