...
console.log('=== 단락평가 ===');
// 1) AND 연산자 (&&)
// : 앞선 피연산자가 false로 평가될 경우, 그 뒤의 피연산자는 평가 없이 바로 false 를 반환

false && console.log('and 연산자의 단락평가'); // X

true && console.log('해당 내용은 출력됩니다.'); // 출력

// 2) OR 연산자 (||)
// : 앞선 피연산자의 true가 하나라도 존재하는 경우, 그 뒤의 피연산자는 평가 없이 바로 true 를 반환

true || console.log('or 연산자의 단락평가'); // X 

false || console.log('해당 내용은 출력됩니다.'); // 출력
...
// 반환값1: 조건이 참(true)일 때 반환될 값.
// 반환값2: 조건이 거짓(false)일 때 반환될 값.
...
let isMember = false; // boolean 타입의 변수
