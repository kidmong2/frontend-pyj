...
document.write(birthYear + "년 에 태어난 사람의 나이는 " + age + "세 입니다.");
...
privateLibrary(); // 함수의 호출
// console.log(secretBook); - Error (전역 범위에는 secrectBook 변수가 존재하지 않는다.)


//? 3. 블록 스코프
// : {} 중괄호로 둘러싸인 블록 내부에서만 접근 가능
if(true) {
  // 블록{}으로 생성된 사용자 정의 스코프
...
//! 변수의 호이스팅
//? var의 호이스팅
// var a; 변수가 선언만 되고 값이 할당되지 않음
console.log(a); 
var a = 5;


//? let과 const의 호이스팅
// console.log(b); - Error 초기화 전에 b에 접근할 수 없음 (호이스팅은 되었지만 TDZ가 변수의 선언부에 접근 할 수 없도록 방지)
let b = 10;
