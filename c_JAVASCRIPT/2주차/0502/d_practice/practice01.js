...
const scores = [65, 25, 100, 80, 35, 55, 40];
const countPassingScores = scores.filter(value => value >= 60);

console.log(countPassingScores);
let length = countPassingScores.length;
console.log(length);
