...
let numbers = [1, 2, 3, 4];
let sum = numbers.reduce((accumulator,currentValue) => accumulator + currentValue // sum += currentValue
, 0)
...
// numberArray.sort(); // 콜백함수 생략 -> 유니코드값 순서대로 정렬
...
numbers = [5, 4, 3, 6, 1];
// find() : 해당 조건을 만족하는 첫번째 요소를 반환
let firstOverfive = numbers.find(num => num >5);

// findIndex() : 해당 조건을 만족하는 첫번째 인덱스를 반환
