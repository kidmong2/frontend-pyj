...
function Person(firstName, lastName, age, gender, interests) {
  ...
  this.greeting = function() {
    // 일반적으로 객체의 메서드는 해당 겍체의 속성을 활용하는 용도가 많기 때문에 객체 자체를 가리키는 this 사용이 빈번
    // 일반 함수 사용을 권장, 화살표 함수 X
    console.log(`Hello, ${this.name.first}`);
  }
}

let person1 = new Person('용재', '박', 27, 'male', ['reading', 'watching']);
let person2 = new Person('철수', '김', 27, 'male', ['reading', 'watching']);
...
let PersonA = new Person2('김채원', 24, '가수');
let PersonB = new Person2('조유리', 22, '가수');
