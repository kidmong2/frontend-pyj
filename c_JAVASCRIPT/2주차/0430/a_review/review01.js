...
function fireball(mp) {
  if(mp >= 15) {
    const damage = 25;
    mp -= 15;
    console.log(`파이어볼 사용: 적에게 ${damage} 의 공격을 하였습니다. 남아있는 mp는 ${mp} 입니다.`);
  }
  else {
    console.log('파이어볼 사용 불가!!');
  }
  return mp;
}

// !메디테이션 기술을 사용하는 함수 정의
...
function main () {
  ...
  // input, output 의 입력과 출력에 대한 공간이 생성

  // rl.question() : 사용자에게 질문, 응답을 받아 처리
