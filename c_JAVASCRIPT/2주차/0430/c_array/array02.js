...
console.log(copiedArray); // [1,2,3] - 원본 배열 수정해도 copiedArray는 영향 받지 않는다

let array1 = [11, 12, 13];
let array2 = array1;

array1[1] = 55;
console.log(array2); // [11, 55, 13]
...
let result = fruits.join(); // 구분자 사용 X
let resultWithSpace = fruits.join('  '); // 구분자 사용 X
let resultWithDash = fruits.join(' - '); // 구분자 사용 X
