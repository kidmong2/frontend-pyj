...
// EX) 두 수의 곱을 계산하는 자바스크립트 함수
function multiply(a, b) {
  return a * b;
}

console.log(multiply(2, 3)); // 6
console.log(multiply(23949, 20013));
let result = multiply(60, 12);
console.log(result);
...
console.log(calDistance(3, 4, 0, 0));
...
greet(); // 호이스팅 덕분에 정상 실행 됨

function greet() {
  // 함수 선언
  console.log("안녕하세요. 함수 선언식 입니다.");
}
...
console.log(pyj());
//? console.log(job); - Error (지역변수의 값에 접근하지 못함)
