...
// ./ : 해당 모듈이 위치한 디렉토리 내의 환경
// ..// 해당 모듈이 위치한 디렉토리의 부모 디렉토리 환경

// EX) ./practice01/'mathutils.js';
// EX2) b_CSS의 0419디렉토리 내로 이동
// : ../../../../b_CSS/0419
...
// packag.json 파일생성 : node.js 프로젝트의 설정과 중속성 관리
// : 해당 디렉토리를 module을 사용할 수 있는 타입으로 지정
// >> 해당 프로젝트의 모든 JS 파일들을 ES 모듈로 처리 가능

// 원하고자 하는 디렉토리 터미널에서
// npm init 
// : package.json을 자동생성하는 명령어

// npm init -y 
// : 프로젝트의 이름, 버전, 진입점 등의 질문을 기본 답변으로 package.json 파일을 빠르게 생성해주는 명령어