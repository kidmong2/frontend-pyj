...
window.onkeydown = function(event) {
  const keyDownText = `키를 눌렀습니다. ${event.key}`;
...
//   // 각각의 요소에 접근할 때마다 해당 요소에 onclick 속성으로 colorChange 함수 전달
...
// 필요한 경우, 이벤트 리스너 제거
// : 현재에는 리스너 제거를 등록할 경우 이벤트가 없는 것처럼 작용
