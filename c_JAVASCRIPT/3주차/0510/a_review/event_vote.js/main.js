...
//! HTML 요소 가져오기
const optionsConatiner = document.getElementById("options-container");
...
options.forEach((option, index) => {
  ...
  optionsConatiner.appendChild(label);
...
submitBtn.addEventListener('click', () => {
  // 현재 문서에서 이름이 option인 라디오 버튼 중에서 선택된 라디오 버튼을 찾아오기
  // : input의 라디오, checkbox의 경우 checked 속성
