...
// : 위의 url 에서 사용하고자 하는 데이터를 /posts, /comments, /users 등을 붙여 사용
// : 각각의 데이터 속에서 원하고자 하는 데이터를 검색할 경우, /id값(숫자)
// 예) id가 2인 posts를 가져오는 경우
// https://jsonplaceholder.typicode.com/posts/2

async function fetchPosts(postsId) {
  try {
    ...
    console.log('게시물 가져오기를 실패하였습니다.', error);
  }
}
