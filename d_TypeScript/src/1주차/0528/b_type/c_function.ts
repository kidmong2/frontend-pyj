// c_function.ts
{
  ...
  console.log(arrowGreet('박용재')); // Hello, 박용재
  ...
  // name은 김민주, greeting은 hello
  select('김민주', 'hello'); // hello, 김민주
  ...
  console.log(r2);
  const r3 = sum(10, 20 ,3, 40);
  console.log(r3);




length;  // 첫 번째 인자는 name의 변수에
