...
var UserManager = /** @class */ (function (_super) {
    ...
    UserManager.prototype.displayUsers = function () {
        var _a;
        var tableBody = (_a = document.getElementById('userTable')) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('tbody')[0];
        if (tableBody) {
            tableBody.innerHTML = this.users.map(function (user) {
